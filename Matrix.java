...
public class Matrix {
    public static void main(String[] args) throws Exception {
       ...
       if (num == 1) {
       System.out.print("Enter file one:");
       input.nextLine(); 
       String filename = input.nextLine();       
     int [][]matrix1 = readMatrixFromFile(filename);
    System.out.print("Enter file two:");   
     String filename2 = input.nextLine();
      ...
      int[][] product = multiplyMatrix(matrix1, matrix2);
       ...
       System.out.println("Enter the amount for the rows:");
         rows = input.nextInt();
       System.out.println("Enter the amount for the columns:");
         cols = input.nextInt();
